...
class DropdownSearchApp extends StatefulWidget {
  ...
  @override
  State<DropdownSearchApp> createState() => DropdownSearchAppState();
}

class DropdownSearchAppState extends State<DropdownSearchApp> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("dropdown_search")),
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            ...
            children: [
              ...
              const Text("[supabase search dropdown example]"),
              const Divider(),
              Row(
                children: [
                  Expanded(
                    ...
                    return Column(
                      ...
                      children: [
                        const Padding(
                          ...
                          child: Text('should bne image here...'),
                        ),
                        Flexible(
                          child: Container(
